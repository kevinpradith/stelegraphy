      ...
      <div className="layout">
        ...
        <main className="main">
          ...
          <div className="panel-header">
            ...
            {!cipher.symmetric && <ModeToggle mode={mode} onChange={setMode} />}
          </div>

          {/* ── Optional params (key) */}
          {cipher.needsKey && <ParamsBar cipher={cipher} keyValue={key} onKeyChange={setKey} />}

          {/* ── IO panels */}
          <IOGrid input={input} output={output} onInputChange={setInput} onSwap={handleSwap} />
        </main>
      </div>
    </div>
  )
