    ...
    <aside className="sidebar guide-sidebar" aria-label="Stelegraphy Guide">
      ...
      <div className="sidebar-footer">
        ...
        <div className="credit-links">
          <a href="https://github.com/kevinpradith" target="_blank" rel="noopener noreferrer" className="credit-link">
          ...
          <a href="https://www.linkedin.com/in/kevinpradith/" target="_blank" rel="noopener noreferrer" className="credit-link">
